...
class KSideMenuVC: UIViewController,UIGestureRecognizerDelegate {
    ...
    func setUp(){
        self.distanceOpenMenu = self.view.frame.size.width-(self.view.frame.size.width/2);
...
//        }
    ...
    func openMenu(){
        ...
        UIView.animate(withDuration: 0.4, delay: 0.0, options: UIViewAnimationOptions.beginFromCurrentState, animations: { () -> Void in
            ...
            tRotate.m34 = 1.0/(-500)
            let aXpos: CGFloat = CGFloat(-20.0*(Double.pi/180))
